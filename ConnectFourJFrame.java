...
public class ConnectFourJframe extends JFrame {
	...
	private JTextField txtPlayerEnter;
	...
	public static void main(String[] args) {
		...
		*/
		...
		Game game = new Game(); //Nytt
		Player player = new Player("name"); //Nytt
		ConnectFourController controller = new ConnectFourController(view, model, game, player); //NYTT
